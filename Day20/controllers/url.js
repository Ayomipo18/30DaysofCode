...
const shortenUrl = async (req, res) => {
    ...
    let valid = /^[A-Za-z0-9-_]\w{0,3}$/.test(unique_name);
    if(!valid) return res.json({ok : false, msg : "Only 'A-Z', 'a-z', '0-9', '-' and '_' characters with max of 3 are allowed in the unique name"});
